        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              ...
              <Block >
                <Block>
                  <Text color="white" size={60}>Nyeri</Text>
                </Block>
                <Block>
                  <Text color="white" size={40}>CarHire</Text>
                </Block>
                <Block row>
                  <Text color="white" size={30}>Pay with mpesa</Text>
                  <Block middle style={styles.pro}>
                    <Text size={8} color="white">josh_enterprise</Text>
                  </Block>
                </Block>
              </Block>
              ...
              <Button
                ...
                <Text bold color={theme.COLORS.WHITE}>Proceed to Payment</Text>
              </Button>
            </Block>
          </Block>
        </Block>
